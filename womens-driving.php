<?
    $CatPage = true; 
    $PageTitle = ' - Womens Driving Gloves';
?>
    ...
    <div class="sub-category-wrapper">
            <div class="cat-info-wrapper">
                <div class="cat-inner-wrapper">
                    ...
                    <div class="cat-title">womens driving gloves</div>
                    <div class="lg-spacer"></div>
                    <div class="lg-spacer"></div>
                    <div class="lg-spacer"></div>
                    <div class="brown-header">from the road</div>
                    <div class="brown-header large">to the runway.</div>
            ...
            <div class="cat-image womens-driving"></div>
