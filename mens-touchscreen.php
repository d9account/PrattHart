    ...
    <div class="sub-category-wrapper">
            ...
            <div class="cat-info-wrapper">
                <div class="cat-inner-wrapper">
                    ...
                    <div class="cat-title">mens touchscreen gloves</div>
                    <div class="lg-spacer"></div>
                    <div class="lg-spacer"></div>
                    <div class="lg-spacer"></div>
                    <div class="brown-header">warm & cozy</div>
                    <div class="brown-header large">in a manly way</div>
            ...
            <div class="cat-image mens-winter"></div>
