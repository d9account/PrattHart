<?
    $CatPage = true; 
    $PageTitle = ' - Womens Touchscreen Gloves';
?>
    ...
    <div class="sub-category-wrapper">
            ...
            <div class="cat-info-wrapper">
                <div class="cat-inner-wrapper">
                    ...
                    <div class="cat-title">womens touchscreen gloves</div>
                    <div class="lg-spacer"></div>
                    <div class="lg-spacer"></div>
                    <div class="lg-spacer"></div>
                    <div class="brown-header">totally</div>
                    <div class="brown-header large">tweetable</div>
            ...
            <div class="cat-image womens-touchscreen"></div>

            <div class="clear"></div>

            <div class="cat-links-wrapper">

               <?php include 'includes/womens_cats_inc.php';?>
